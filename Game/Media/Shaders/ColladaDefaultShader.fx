...
< 
string ContextSwitchNames[] = { "NUM_LIGHTS", "LOD_BLEND", "VELOCITY_ENABLED", "MULTISLICE_VR" };
...
// Material Parameters
float4 MaterialColor : MATERIALCOLOR <string UIWidget = "ColorPicker"; string UIName = "Material Color"; string UILabel = "The material color.";> = float4(1.0f,1.0f,1.0f,1.0f);
float4 MaterialTransparency : MATERIALTRANSPARENCY <string UIWidget = "ColorPicker"; string UIName = "Material Transparency"; string UILabel = "The material transparency.";> = float4(0,0,0,0);
float4 MaterialAmbient : MATERIALAMBIENT <string UIWidget = "ColorPicker"; string UIName = "Material Ambient"; string UILabel = "The material ambient.";> = float4(0,0,0,0);
float4 MaterialEmission : MATERIALEMISSION <string UIWidget = "ColorPicker"; string UIName = "Material Emission"; string UILabel = "The material emission.";> = float4(0,0,0,0);
float4 MaterialDiffuse : MATERIALDIFFUSE <string UIWidget = "ColorPicker"; string UIName = "Material Diffuse"; string UILabel = "The material diffuse.";> = float4(1,1,1,1);
...
float AlphaGain : ALPHAGAIN <string UIName = "Alpha Gain";> = 1.0f;
...
// Calculate previous and current position of vertex to be passed to pixel shader for velocity calculation.
...
DefaultVSForwardRenderOutput DefaultForwardRenderVS(DefaultVSInput IN)
{
	...
	OUT.Position = mul(float4(OUT.WorldPosition,1.0f), MultiSliceParams[IN.InstanceID].ViewProjection);
...
// Default fragment shader. 
void DefaultShadowFP()
{
}

// Transparent shadow fragment shader. 
void ShadowTransparentFP(ShadowTransparentVSOutput In)
{
#ifdef TEXTURE_ENABLED
...
<
	...
	string FpIgnoreContextSwitches[] = { "MULTISLICE_VR" };
>
{
	pass pass0
	{
...
<
    ...
    string FpIgnoreContextSwitches[] = { "VELOCITY_ENABLED", "MULTISLICE_VR" };
>
{
	pass pass0
	{
...
<
	...
	string VpIgnoreContextSwitches[] = { "NUM_LIGHTS", "LOD_BLEND", "VELOCITY_ENABLED", "MULTISLICE_VR" };
    string FpIgnoreContextSwitches[] = { "NUM_LIGHTS", "VELOCITY_ENABLED", "MULTISLICE_VR" };
>
{
	pass p0
	{
...
<
	...
	string VpIgnoreContextSwitches[] = {"NUM_LIGHTS", "LOD_BLEND" };
	string FpIgnoreContextSwitches[] = {"NUM_LIGHTS", "MULTISLICE_VR" };
>
{
	pass p0
	{
