...
/*--------------------------------------------------------------------------*/
    ...
    FxaaFloat dest = min(dstN, dstP);
    FxaaBool goodSpan = directionN ? goodSpanN : goodSpanP;
    FxaaFloat subpixG = subpixF * subpixF;
    FxaaFloat pixelOffset = (dest * (-spanLengthRcp)) + 0.5;
...
#ifdef __SCE_CGC__ // SCE R&D PhyreEngine change to only enable #pragmas in sce-cgc build
#pragma regcount 7
#pragma disablepc all
#pragma option O2
#pragma option OutColorPrec=fp16
