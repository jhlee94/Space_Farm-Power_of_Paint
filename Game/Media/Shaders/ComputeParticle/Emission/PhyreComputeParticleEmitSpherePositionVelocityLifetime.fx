...
{
	PEmitSpherePositionVelocityLifetimeStateStruct	emissionState;							// The emission state for emitting sphere positions, velocities and lifetimes.
};

[numthreads(64, 1, 1)]
void CS_EmitSpherePositionVelocityLifetime(uint3 DispatchThreadId : SV_DispatchThreadID)
{
...
technique11 EmitSpherePositionVelocityLifetime
{
	pass p0
	{
		SetComputeShader( CompileShader( cs_5_0, CS_EmitSpherePositionVelocityLifetime() ) );
	}
};
